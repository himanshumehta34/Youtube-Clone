import amazon from "./Icons/amazon.jpg";
import lallantop from "./Icons/Lallantop.jpg";
import tseries from "./Icons/tseries.jpg";
import pw from "./Icons/pw.jpg";
import insaan from "./Icons/insaan.jpg"
    ...
    <>
      ...
      <div class="main-section">
        <div class="main-left">
          ...
          <button class="yt-side-button">
            <img src={amazon} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">Amazon Prime</span>
          </button>

          <button class="yt-side-button">
            <img src={lallantop} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">The Lallantop</span>
          </button>
        ...
        <div class="main-right">
          <div className="navbar-container">
            <div class="navbar">
              ...
              <div class="navbar-items white">Movies</div>
              ...
              <div class="navbar-items white">Cricket</div>
              ...
              <div class="navbar-items white">Music</div>
              <div class="navbar-items white">Comedy</div>
            </div>
          </div>
